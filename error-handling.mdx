...
Rate limits depend on your subscription plan. The free tier allows **300 calls/day at 1 request per second**. Higher plans increase both the daily quota and requests-per-second ceiling.
