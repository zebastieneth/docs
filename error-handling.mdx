...
<AccordionGroup>
  ...
  <Accordion title="Use webhooks instead of polling">
    If you need to monitor wallet activity, use [transaction subscriptions](/api-reference/tx-subscriptions/create-subscription-wallet-transactions) instead of polling the transactions endpoint. This reduces your API usage and gives you faster notifications.
  </Accordion>
</AccordionGroup>
