...
<Tabs>
  ...
  <Tab title="PnL">
    <div style={{display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2rem", alignItems: "start"}}>
      ...
      <img src="/images/pnl.png" alt="Zerion PnL view" style={{maxWidth: "400px", borderRadius: "12px", margin: "0 auto"}} noZoom />
    </div>
  </Tab>
  ...
  <Tab title="NFTs">
    <div style={{display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2rem", alignItems: "start"}}>
      <div>
        ...
        <a href="/api-reference/wallets/get-wallet-nft-positions" class="hero-cta" style={{marginTop: "1.5rem", display: "inline-flex"}}>View recipe →</a>
      </div>
      <img src="/images/nfts.png" alt="Zerion NFT positions view" style={{maxWidth: "400px", borderRadius: "12px", margin: "0 auto"}} noZoom />
    </div>
  </Tab>
  ...
  <Tab title="Notifications">
    <div style={{display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2rem", alignItems: "start"}}>
      ...
      <img src="/images/notifications.png" alt="Zerion real-time alerts view" style={{maxWidth: "400px", borderRadius: "12px", margin: "0 auto"}} noZoom />
    </div>
  </Tab>
</Tabs>
