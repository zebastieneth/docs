---
title: "Rate Limits"
description: "Understand rate limits and handle throttled requests."
---
...
Usage monitoring is coming soon to the [Dashboard](https://dashboard.zerion.io). In the meantime, click **Support** in the Dashboard to get in touch — we can provide access to a usage report on request.
